<template>
  <v-container fluid>
    <h1 class="my-5 display-1 subheading grey--text">Catégories</h1>
    <v-card>
      <v-data-table
        :headers="headers"
        :items="categories"
      ...
      >
              ...
              <v-row justify="space-between">
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-btn class="ma-4 brunfonce" @click="dialog = true" large tile dark>
                    <v-icon color="#555" left>mdi-book-plus</v-icon>
        ...
        <template v-slot:item.actions="{ item }">
          <v-row>
            <div class="my-2">
              <v-btn color="black" tile @click="open(item)" fab small dark>
